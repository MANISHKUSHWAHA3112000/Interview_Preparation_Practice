...
public class OopsConcept {
     ...
     * A: Encapsulation is the process of hiding data using private fields and providing controlled access
     *    through public methods (getters/setters).
     * Example: Class A and B below demonstrate encapsulation.
     */
    class A {
        private String name;
        private int age;
        ...
        public void setAge(int age) {
            ...
            else System.out.println("Invalid age! Must be between 1 and 120.");
        }
     ...
     * A: Polymorphism means "many forms". It allows methods to behave differently based on context.
     ...
     * Example: Abstract class Vehicle with abstract method start().
     */
    abstract class Vehicle {
        abstract void start();
        public void fuelType() { System.out.println("Most vehicles use petrol or diesel."); }
    }
    class Car extends Vehicle { @Override void start() { System.out.println("Car starts with a key."); } }
    class Bike extends Vehicle { @Override void start() { System.out.println("Bike starts with a self-start button."); } }
     ...
     * A: They define the scope of variables/methods/classes.
     ...
     * A: Use final class, private final fields, and only getters (no setters).
     */
  ...
  * - Inheritance: compile-time, can cause tight coupling.
  * - Composition: runtime, promotes flexibility and loose coupling.
  */
 class Vehicle1 { 
  ...
  * A:
  * An Interface is used when you want to define a contract that
  * multiple classes can implement, regardless of their position
  * in the class hierarchy. It tells what a class CAN DO.
  * For example, Flyable means any class that implements it
  * must provide the fly() behavior. Interfaces support multiple
  * inheritance, so a class can implement many interfaces.
  *
  * An Abstract Class is used when you want to provide a common
  * base type with some shared code and also enforce rules.
  * It tells what a class IS. Abstract classes can have both
  * abstract methods (without body) and concrete methods (with body).
  * They can also define fields and state. A class can extend only
  * one abstract class, so it is single inheritance.
  *
  * In short:
  * - Interface → capability (CAN DO).
  * - Abstract Class → base type (IS).
  */
 ...
 class Bird extends Animal1 implements Flyable {
     @Override public void fly() { System.out.println("Bird flies in sky."); }
     @Override public void makeSound() { System.out.println("Bird chirps."); }
 }
  ...
  * - Overriding → subclass redefines parent method with same signature (runtime polymorphism).
  * - Overloading: compile-time binding, no inheritance required.
  * - Overriding: runtime binding, requires inheritance.
  */
 class OverloadOverrideExample {
     public void greet(String name) { System.out.println("Hello " + name); }
     public void greet(String name, int age) { System.out.println("Hello " + name + ", age: " + age); }
 }
 ...
 class OverrideChild extends OverrideParent {
     @Override public void greet() { System.out.println("Hello from Child"); }
 }
     ...
     * A:
     * - final → keyword (constant, prevent inheritance/overriding).
    ...
    class FinalExample {
        ...
        @Override protected void finalize() { System.out.println("Finalize called before GC"); }
    }
    ...
    class StringExample {
        public void testStrings() {
             ...
             * - Can request GC using System.gc(), but not guaranteed.
             */
            ...
            public static void main(String[] args) {
                ...
                // Encapsulation
                A a = obj.new A("Manish", 24);   // non-static inner
